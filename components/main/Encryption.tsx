...
security
        ...
        <div className=' flex flex-col items-center jus translate-y-[-50px] absolute z-[20] w-auto h-auto'>
            ...
            <div className=' flex flex-col items-center group cursor-pointer w-auto h-auto '>
                ...
                <Image src='/LockMain.png' alt='LockMain'  width={70} height={70} className='z-10' />
