  ...
  return (
    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        <motion.div className=" flex flex-col gap-6 text-6xl font-bold text-white max-w-[600px] w-auto mt-6 h-auto  " variants={slideInFromLeft(0.5)}>
        <span>
...
learn more! 
      ...
      <motion.div variants={slideInFromRight(0.8)} className=" w-full h-full justify-center items-center ">
